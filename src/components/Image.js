...
export default (props) => {
    ...
    const backgroundStyle = {
       ...
       // transformOrigin: '50% 50% 0',
        fill: 'green',
      //  transform: `translate(${props.tieX}px, ${props.tieY}px)`
       // rotate(${props.bcgRotate}deg)
        // scale(${props.bcgScale})
    };
    const imageStyle = {
        zIndex: 10,
        transform: `scale(${props.imgScale}) translate( ${props.imgX}, ${props.imgY})`
        //rotate(${props.imgRotate} 90 110)
    };

    return (
        <div>
            <div style={{height: '565px', width: '265px'}} id='image-wrapper'>
            ...
            <button onClick={props.saveTie}>Save your tie</button>
        </div>
    )
}