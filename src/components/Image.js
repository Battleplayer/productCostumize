...
export default (props) => {
    ...
    const backgroundStyle = {
        ...
        transform: `scale(${props.bcgScale}) rotate(${props.bcgRotate}deg)`
    };
    return (
        <div>
            <svg version="1.1" x="0px" y="0px" width="377" height="733"
                 viewBox="0 0 674 1466" style={{flex: 1}}>
                <pattern id="poupat" width="71.39" height="44.93" patternUnits="userSpaceOnUse"
                         viewBox="0 0 71.39 44.93"
                         overflow="visible">
                    <g transform="translate(0,50)" style={backgroundStyle} x='10'>
                        <path style={{fill: 'red'}}
                ...
                <image width="128" height="146" transform="rotate(0)"
                       clipPath="url(#myClip)"
                       xlinkHref={props.image}/>
            </svg>
            <button onClick={onSave}>Save your tie</button>
        </div>
    )
}